...
@Configuration
@EnableSolrRepositories(multicoreSupport = true, basePackages = DataArcConfiguration.ORG_DATAARC_SOLR, schemaCreationSupport=true)
...
public class MongoProfile extends DataArcConfiguration {
    ...
    SolrClient solrClient() throws FileNotFoundException {
        ...
        return new EmbeddedSolrServer(container, "general");
    }
