    ...
    <div class="container call-to-action">
      <div class="row">
        <div class="col-lg-8 mx-auto text-center">
          <h2 class="section-heading text-white">Funding</h2>
          <hr class="light">
          <p class="mb-3 mt-4">
            <a href="http://https://www.nsf.gov/awardsearch/showAward?AWD_ID=1637076"><img width="166" height="167" src="/img/nsf_logo_shading.png" class="image wp-image-38  attachment-full size-full" alt="NSF Logo" style="max-width: 100%; height: auto;" sizes="(max-width: 166px) 100vw, 166px"></a>
          </p>
