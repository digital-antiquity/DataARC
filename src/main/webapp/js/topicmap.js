...
console.log(contextPath);
  ...
  function showNodeInfo( node ){
    var html = '<tr>';
    html += '<td width="100%" align="center" class="node-name">'+node.data().name+' <a id="centerNode" title="Center this node in a concentric layout" data-id="'+node.data().id+'" href="javascript:;"><span class="fa fa-dot-circle-o"></span></a></td>';
    html += '</tr>';
  ...
  function showEdgeInfo( edge ){
    var html = '<tr>';
    html += '<td align="center" width="33%" class="node-name">'+edge.source().data().name+' <a class="centerNode" id="centerNode" title="Center this node in a concentric layout" data-id="'+edge.source().data().id+'" href="javascript:;"><span class="fa fa-dot-circle-o"></span></a></td>';
    html += '<td align="center" width="33%" class="node-name node-name-edge">'+edge.data().name+'</td>';
    html += '<td align="center" width="33%" class="node-name">'+edge.target().data().name+' <a class="centerNode" id="centerNode" title="Center this node in a concentric layout" data-id="'+edge.target().data().id+'" href="javascript:;"><span class="fa fa-dot-circle-o"></span></a></td>';
    html += '</tr>';
    $('#infotable').html(html).show();
    $('.centerNode').on('click',centerNode);
  }
...
//        $term.trigger("keyup");
  ...
  function changeLayout(layout, id){
    ...
    if(layout=='preset'){
      ...
      layoutOptions.minNodeSpacing = 1;
      circleSpecs = {};
      allNodes.forEach(function(n){
