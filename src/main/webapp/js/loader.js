...
class LoaderHandler {
  constructor() {
    ...
    this.large = '<div class="d-flex h-100 align-items-center"><div class="mx-auto"><span class="fa fa-cog fa-spin fa-4x"></span></div></div>';
    this.small = '<div class="d-flex h-100 align-items-center"><div class="mx-auto"><span class="fa fa-cog fa-spin fa-1x"></span></div></div>';
  }
  show() {
